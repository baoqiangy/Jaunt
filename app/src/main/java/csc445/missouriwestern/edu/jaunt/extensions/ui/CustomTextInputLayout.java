 ...
 * Borrowed from https://gist.github.com/drstranges/1a86965f582f610244d6#file-custom_input_layout_res-xml
 */
...
public class CustomTextInputLayout extends TextInputLayout {
    ...
    public CustomTextInputLayout(Context _context, AttributeSet _attrs) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                _attrs,
                R.styleable.CustomTextInputLayoutStyle,0,0);
        try {
            mHelperTextColor = a.getColorStateList(R.styleable.CustomTextInputLayoutStyle_helperTextColor);
            mHelperText = a.getText(R.styleable.CustomTextInputLayoutStyle_helperText);
        } finally {
            a.recycle();
        }
    }
        ...
        if (this.mHelperTextEnabled != _enabled) {
            if (_enabled) {
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
                    ...
                    this.mHelperView.setTextAppearance(this.mHelperTextAppearance);
                }
